...
public abstract class Entity{
   ...
   public boolean isCollidingWith(Entity other){
   	   if ((other.getX() + other.getWidth()) < this.getX()||(this.getX() + this.getWidth()) < other.getX()){
   	   	   return false;
   	   }
   	   else if ((other.getY() + other.getHeight()) < this.getY() || (this.getY() + this.getHeight()) < other.getY()){
   	   	   return false;
   	   }
   	   else {
   	   	   return true;
